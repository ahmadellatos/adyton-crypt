...
_TRANSLATIONS: dict[str, dict[str, str]] = {
    "id": {
        ...
        "settings.theme": "Tema",
        "settings.theme.desc": "Gelap, Terang, atau ikuti sistem.",
        "settings.theme.dark": "Gelap",
        "settings.theme.light": "Terang",
        "settings.theme.system": "Sistem",
        "settings.theme.restart": "Buka ulang untuk menerapkan tema baru.",
        "settings.theme.restart_btn": "Restart sekarang",
        ...
        "restart.busy.title": "Operasi Sedang Berjalan",
        "restart.busy.msg": "Adyton sedang mengenkripsi atau mendekripsi file.\n\nTunggu sampai selesai sebelum restart.",
        "restart.failed.title": "Tidak bisa restart",
        "restart.failed.msg": "Adyton tidak bisa menjalankan ulang dirinya. Tutup dan buka kembali aplikasi untuk menerapkan tema baru.",
        ...
        "open.verify.click_cancel": "Klik untuk membatalkan",
        "open.verify.ok.title": "Integritas terverifikasi",
        "open.verify.ok.sub": "Credential benar • semua data utuh",
        "open.verify.ok.msg": "Vault terverifikasi — semua data utuh.",
        "open.verify.fail.title": "Cek integritas gagal",
        ...
        "open.browse.ok.title": "Isi vault siap",
        "open.browse.ok.sub": "Pilih yang mau diekstrak",
        "open.browse.fail.title": "Tidak bisa membaca isi",
        "open.browse.fail.sub": "Vault mungkin rusak atau telah diubah",
        "open.browse.fail.msg": "Tidak bisa membaca isi vault. Mungkin rusak.",
        "open.extract.stage": "Mengekstrak file",
        "open.extract.busy.title": "Mengekstrak file terpilih",
        "open.extract.busy.sub": "Menulis ke tujuan • Klik untuk membatalkan",
        "open.extract.pick_dest": "Pilih lokasi untuk mengekstrak item terpilih",
        "open.extract.ok.title": "Ekstraksi selesai",
        "open.extract.ok.sub": "Item terpilih telah disimpan",
        "open.extract.ok.msg": "Item terpilih diekstrak ke '{name}'.",
        "open.extract.notif": "Ekstraksi selesai — '{name}' siap.",
        "open.extract.fail.title": "Ekstraksi gagal",
        "open.extract.fail.sub": "Periksa tujuan, izin, atau ruang disk",
        "open.extract.fail.msg": "Tidak bisa mengekstrak item terpilih.",
        # ── Dialog browse isi vault ─────────────────────────────────────────
        "browser.title": "Isi vault",
        "browser.subtitle": "'{root}' • {count} file • {size}",
        "browser.col.name": "Nama",
        "browser.col.size": "Ukuran",
        "browser.select_all": "Pilih semua",
        "browser.select_none": "Kosongkan",
        "browser.selected_summary": "{count} dipilih • {size}",
        "browser.extract": "Ekstrak Terpilih",
        "browser.empty": "Vault ini kosong.",
        ...
        "manage.keyfile.none": "Belum ada keyfile dipilih",
        "manage.keyfile.choose": "Pilih keyfile",
        "manage.keyfile.dialog": "Pilih keyfile",
        "manage.keyfile.add.warn": "Kamu akan membutuhkan file ini DAN password setiap kali membuka vault ini. Simpan cadangannya — kehilangan keyfile berarti hanya recovery key yang bisa membukanya.",
        "manage.keyfile.add.none": "Belum ada keyfile dipilih",
        "manage.keyfile.add.choose": "Pilih file…",
        "manage.keyfile.add.generate": "Buat…",
        "manage.keyfile.add.dialog": "Pilih keyfile",
        "manage.keyfile.add.note": "Mengaktifkan 2FA membutuhkan password kamu (recovery key tidak berlaku di sini).",
        "manage.keyfile.add.btn": "Aktifkan Keyfile (2FA)",
        "manage.keyfile.add.missing": "Pilih atau buat keyfile dulu.",
        "manage.keyfile.remove.state": "Vault ini dilindungi keyfile (2FA).",
        "manage.keyfile.remove.note": "Menghapusnya membutuhkan password dan keyfile saat ini yang dipilih di atas.",
        "manage.keyfile.remove.btn": "Hapus Keyfile (2FA)",
        "manage.keyfile.remove.title": "Hapus Keyfile",
        "manage.keyfile.remove.msg": "Perlindungan keyfile (2FA) akan dihapus. Setelah itu, password saja sudah bisa membuka vault ini.\n\nHapus keyfile?",
        "manage.keyfile.remove.missing": "Pilih keyfile saat ini di atas dulu.",
        "manage.seg.pw": " Password",
        "manage.seg.rec": " Recovery",
        "manage.seg.kf": " Keyfile",
        ...
        # ── Keyfile / 2FA (Tab Kunci) ───────────────────────────────────────
        "keyfile.add.title": "Lindungi dengan keyfile (2FA)",
        "keyfile.add.desc": "Butuh sebuah file rahasia selain password untuk membuka vault ini.",
        "keyfile.warn": "Kamu akan membutuhkan file ini DAN password setiap kali. Simpan cadangannya — kehilangan keyfile berarti hanya recovery key yang bisa membukanya.",
        "keyfile.none": "Belum ada keyfile dipilih",
        "keyfile.choose": "Pilih file…",
        "keyfile.generate": "Buat…",
        "keyfile.choose.dialog": "Pilih keyfile",
        "keyfile.generate.dialog": "Buat keyfile",
        "keyfile.generate.filter": "Keyfile (*.key)",
        "lock.keyfile.empty": "Pilih sebuah keyfile, atau matikan perlindungan keyfile.",
        # ── Opsi (Tab Kunci) ────────────────────────────────────────────────
        ...
        "a11y.btn.verify_vault": "Tombol Verifikasi Integritas Vault",
        "a11y.btn.browse_vault": "Tombol Telusuri Isi Vault",
